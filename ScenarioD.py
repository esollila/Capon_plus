# Scenario D (Q is unknown, gamma is unknown, secondary data available)
# -------------------------------------------------------------------
# See Section IV.D in the reference:
